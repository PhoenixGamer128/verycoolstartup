...
- [x] **Server deployed and accessible with custom domain name** - [My server link](https://pathforeternity.click).
...
- [x] **Visually appealing colors and layout. No overflowing elements.** - I completed this part
- [x] **Use of a CSS framework** - I completed this part
